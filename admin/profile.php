    ...
    <div class="container-fluid">
      ...
      <form class="form-horizontal">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-6">
            <input id="slug" class="form-control" name="slug" type="type" value="" placeholder="slug">
            <p class="help-block">https://mylife/author/<strong>abcd</strong></p>
          </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-6">
            <textarea id="bio" class="form-control" placeholder="Bio" cols="30" rows="6">Let's Begin!</textarea>
          </div>
        </div>
        <div class="form-group">
